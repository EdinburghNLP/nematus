...
#SBATCH --output=/cs/usr/bareluz/gabi_labs/nematus/slurm/en-de_unlung%j.out
...
python3 $nematus_home/nematus/train.py \
    ...
    --valid_remove_parse #&> /cs/usr/bareluz/gabi_labs/nematus/slurm/outunlung$(date "+%Y.%m.%d-%H.%M.%S") &
