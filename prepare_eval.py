...
from consts import get_evaluate_translate_files, get_evaluate_gender_files
...
if __name__ == '__main__':
    ...
    if args.eval_type == 0:
        EN_ANTI_PARSED, ANTI_TRANSLATED_DEBIASED, ANTI_TRANSLATED_NON_DEBIASED, DEBIASED_EVAL, NON_DEBIASED_EVAL, \
        EN_ANTI, EN_ANTI_MERGED, ANTI_TRANSLATED_DEBIASED_PICKLE, \
        ...
        TRANSLATED_NON_DEBIASED_PICKLE, BLEU_GOLD_DATA_FILTERED = get_evaluate_translate_files(args.config_str)
