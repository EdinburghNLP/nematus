...
if __name__ == '__main__':
    ...
    EN_ANTI_PARSED, ANTI_TRANSLATED_DEBIASED, ANTI_TRANSLATED_NON_DEBIASED, DEBIASED_EVAL, \
    NON_DEBIASED_EVAL, EN_ANTI, EN_ANTI_MERGED, ANTI_TRANSLATED_DEBIASED_PICKLE, \
