...
outputh_path=${debias_manager_dir}/${language_dir}/output/not_important.txt
#echo "outputh_path: ${outputh_path}"
output_translate_path=${debias_manager_dir}/${language_dir}/debias/output_translate_${dst_language}.txt
