...
#SBATCH --output=/cs/snapless/oabend/borgr/TG/slurm/preprocess-%j.out
...
workdir=/cs/labs/gabis/bareluz/preprocess/data/${SRC}_${TRG}/${ID} # change to local accordingly
mkdir -p "$workdir"

modeldir=/cs/snapless/oabend/borgr/SSMT/preprocess/model/${ID} # change to local accordingly
mkdir -p "$modeldir"
...
# corpora
train="train"
apply_to="newstest2014-ruen" "newstest2015-ruen"  'newstest2015-enru' "newstest2016-ruen"  'newstest2016-enru' "newstest2017-ruen"  'newstest2017-enru' "newstest2018-ruen"  'newstest2018-enru' "newstest2019-ruen"  'newstest2019-enru' )
