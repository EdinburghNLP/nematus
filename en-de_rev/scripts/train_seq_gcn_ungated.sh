...
#SBATCH --output=/cs/snapless/oabend/borgr/TG/slurm/en-de_rev_unlung%j.out
...
# trg_dev=$data_dir/UD/newstest2013.unesc.tok.tc.bpe.$trg
...
python3 $nematus_home/nematus/train.py \
    ...
    --valid_remove_parse #&> /cs/snapless/oabend/borgr/TG/slurm/outunlung$(date "+%Y.%m.%d-%H.%M.%S") &
