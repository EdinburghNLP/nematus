from consts import TRANSLATE_SEPARATE_BAD_LINES, BLEU_SOURCE_DATA, BLEU_GOLD_DATA, BLEU_SOURCE_DATA_FILTERED,\
    BLEU_GOLD_DATA_FILTERED, BLEU_SOURCE_DATA_FILTERED2, BLEU_GOLD_DATA_FILTERED2,TRANSLATED_NON_DEBIASED, \
    TRANSLATED_NON_DEBIASED2,TRANSLATED_DEBIASED, TRANSLATED_DEBIASED_PICKLE, TRANSLATED_NON_DEBIASED_PICKLE, BLEU_GOLD_DATA_FILTERED_PICKLE
